...
export const enAnalysis = {
  ...
  description: `This web development project is an advanced platform for searching GitHub repositories. Using cutting-edge technologies like React, TypeScript, CSS, Styled Components, and HTML, this project provides a sleek and intuitive solution for users.\n\n
...
export const ptAnalysis = {
  title: "Add Posts",
  description: `Este projeto de desenvolvimento web é uma plataforma avançada para a realização de buscas de repositórios no GitHub. Utilizando as tecnologias React, TypeScript, CSS, Styled Components e HTML, este projeto oferece uma solução eficiente e intuitiva para os usuários.\n\n
