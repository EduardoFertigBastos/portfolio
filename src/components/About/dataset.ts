...
const dataset = {
  ...
  pt: {
    ...
    Para mim, o desenvolvimento vai além do código. Acredito no poder das soft skills. Sou defensor da comunicação efetiva, trabalho em equipe e prezo pela empatia. Com uma dose constante de curiosidade, estou entusiasmado para contribuir em projetos que realmente façam a diferença.`,
